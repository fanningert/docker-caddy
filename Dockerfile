...
RUN apk add --no-cache --update php7-bcmath php7-curl php7-exif php7-fileinfo php7-gd php7-gettext php7-iconv php7-intl php7-json php7-mbstring php7-mcrypt php7-mysqli php7-opcache php7-pdo php7-pdo-mysql php7-soap php7-sqlite3 php7-xml php7-xmlrpc php7-xsl php7-zip php7-zlib
